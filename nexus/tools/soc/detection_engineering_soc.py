...
def run(target: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not target or not target.strip():
        return tool_result("soc.detection_engineering_soc", target, status=STATUS_FAILED, error="Empty target")
    ...
    try:
        try:
            ...
            findings.append(Finding(
                ...
                tool="soc.detection_engineering_soc",
            ))
        except Exception:
            pass
        ...
        return tool_result("soc.detection_engineering_soc", target, status=status, findings=findings)

    except Exception as e:
        return tool_result("soc.detection_engineering_soc", target, status=STATUS_FAILED, error=str(e))
...
tool_registry.register("soc.detection_engineering_soc", run, metadata={
    ...
    "domain": "soc",
    "status": "completed",
    "description": "soc tool: Detection Engineering Soc",
    "parameters": {
