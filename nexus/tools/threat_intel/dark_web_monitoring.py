...
def run(target: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not target or not target.strip():
        return tool_result("threat_intel.dark_web_monitoring", target, status=STATUS_FAILED, error="Empty target")
    ...
    try:
        try:
            ...
            findings.append(Finding(
                ...
                tool="threat_intel.dark_web_monitoring",
            ))
        except Exception:
            pass
        ...
        return tool_result("threat_intel.dark_web_monitoring", target, status=status, findings=findings)

    except Exception as e:
        return tool_result("threat_intel.dark_web_monitoring", target, status=STATUS_FAILED, error=str(e))
