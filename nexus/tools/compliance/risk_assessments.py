...
def run(target: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not target or not target.strip():
        return tool_result("compliance.risk_assessments", target, status=STATUS_FAILED, error="Empty target")
    ...
    try:
        try:
            ...
            findings.append(Finding(
                ...
                tool="compliance.risk_assessments",
            ))
        except Exception:
            pass
        ...
        return tool_result("compliance.risk_assessments", target, status=status, findings=findings)

    except Exception as e:
        return tool_result("compliance.risk_assessments", target, status=STATUS_FAILED, error=str(e))
...
tool_registry.register("compliance.risk_assessments", run, metadata={
    ...
    "domain": "compliance",
    "status": "completed",
    "description": "compliance tool: Risk Assessments",
    "parameters": {
