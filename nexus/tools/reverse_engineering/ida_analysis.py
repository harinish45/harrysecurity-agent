...
def run(target: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not target or not target.strip():
        return tool_result("reverse_engineering.ida_analysis", target, status=STATUS_FAILED, error="Empty target")
    ...
    try:
        try:
            ...
            findings.append(Finding(
                ...
                tool="reverse_engineering.ida_analysis",
            ))
        except Exception:
            pass
        ...
        return tool_result("reverse_engineering.ida_analysis", target, status=status, findings=findings)

    except Exception as e:
        return tool_result("reverse_engineering.ida_analysis", target, status=STATUS_FAILED, error=str(e))
...
tool_registry.register("reverse_engineering.ida_analysis", run, metadata={
    ...
    "domain": "reverse_engineering",
    "status": "completed",
    "description": "reverse_engineering tool: Ida Analysis",
    "parameters": {
