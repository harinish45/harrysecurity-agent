...
def run(target: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if not target or not target.strip():
        return tool_result("blue_team.detection_engineering_blue", target, status=STATUS_FAILED, error="Empty target")
    ...
    try:
        try:
            ...
            findings.append(Finding(
                ...
                tool="blue_team.detection_engineering_blue",
            ))
        except Exception:
            pass
        ...
        return tool_result("blue_team.detection_engineering_blue", target, status=status, findings=findings)

    except Exception as e:
        return tool_result("blue_team.detection_engineering_blue", target, status=STATUS_FAILED, error=str(e))
...
tool_registry.register("blue_team.detection_engineering_blue", run, metadata={
    ...
    "domain": "blue_team",
    "status": "completed",
    "description": "blue_team tool: Detection Engineering Blue",
    "parameters": {
