...
AGENT_REGISTRY = {
    ...
    "verification_agent": "nexus.agents.orchestrator.verification_agent.VerificationAgent",
    "debate_consensus_agent": "nexus.agents.orchestrator.debate_consensus_agent.DebateConsensusAgent",
    "attack_chain_agent": "nexus.agents.orchestrator.attack_chain_agent.AttackChainAgent",
    "blast_radius_agent": "nexus.agents.orchestrator.blast_radius_agent.BlastRadiusAgent",
    "mitre_mapping_agent": "nexus.agents.orchestrator.mitre_mapping_agent.MitreMappingAgent",
    "poc_recorder_agent": "nexus.agents.orchestrator.poc_recorder_agent.PocRecorderAgent",
    "budget_governor_agent": "nexus.agents.orchestrator.budget_governor_agent.BudgetGovernorAgent",
    "report_tone_agent": "nexus.agents.orchestrator.report_tone_agent.ReportToneAgent",
    "benchmark_harness_agent": "nexus.agents.orchestrator.benchmark_harness_agent.BenchmarkHarnessAgent",
    "prompt_injection_guard_agent": "nexus.agents.defensive.prompt_injection_guard_agent.PromptInjectionGuardAgent",
    "continuous_asm_agent": "nexus.agents.defensive.continuous_asm_agent.ContinuousAsmAgent",
    "digital_twin_agent": "nexus.agents.offensive.digital_twin_agent.DigitalTwinAgent",
...
TIER_MAP = {
    "orchestrator": [
        ...
        "verification_agent", "debate_consensus_agent", "attack_chain_agent",
        "blast_radius_agent", "mitre_mapping_agent", "poc_recorder_agent",
        "budget_governor_agent", "report_tone_agent", "benchmark_harness_agent",
    ],
    "offensive": [
